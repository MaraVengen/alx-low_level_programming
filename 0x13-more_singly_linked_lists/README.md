...
File 3-add_noteint_end.c is a function that adds a new node at the end of a listint_t list.
...
File 100-reverse_listint.c is a function tht reverses a linked list.

File 101-print_listint_safe.c is a function tat prints a listint_t linked list, safely.
